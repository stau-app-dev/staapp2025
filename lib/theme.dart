...
/// Centralized ThemeData wired to the tokens defined in `lib/styles.dart`.
...
MaterialColor createMaterialColor(Color color) {
  // Use modern component accessors to avoid deprecated API usage.
  final int r = (color.r * 255).round();
  final int g = (color.g * 255).round();
  final int b = (color.b * 255).round();
  final int primary = color.toARGB32();
  return MaterialColor(primary, <int, Color>{
